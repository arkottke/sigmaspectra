...
class MotionLibrary : public QAbstractTableModel
{
    ...
    const QVector<double> & targetSaPlusStd() const;
    const QVector<double> & targetSaMinusStd() const;
...
private:
    /*! Log-log interpolation.
         ...
         */
    static bool interp( const QVector<double> & x, const QVector<double> & y, const QVector<double> & xi, QVector<double> & yi);
