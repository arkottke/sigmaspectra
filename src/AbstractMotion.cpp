...
const QString & AbstractMotion::station() const
{
    return m_station;
}

const QString & AbstractMotion::event() const
{
    return m_event;
}

double AbstractMotion::damping()
{
    return m_damping;
}

void AbstractMotion::setDamping(const double damping)
{
    m_damping = damping;
}


AbstractMotion::Flag AbstractMotion::flag() const
{
    return m_flag;
}

void AbstractMotion::setFlag(Flag flag)
{
    m_flag = flag;
}
...
QList<QString> AbstractMotion::flags()
{
    return QList<QString>()
            << QObject::tr("Required")
            << QObject::tr("Requested")
            << QObject::tr("Unmarked")
            << QObject::tr("Disabled");
}

const QVector<double> & AbstractMotion::period()
{
    return m_period;
}

void AbstractMotion::setPeriod(QVector<double> & period)
{
    m_period = period;
}

const QVector<double> & AbstractMotion::sa() const
{
    return m_sa;
}

const QVector<double> & AbstractMotion::lnSa() const
{
    return m_lnSa;
}

double AbstractMotion::avgLnSa() const
{
    return m_avgLnSa;
}
